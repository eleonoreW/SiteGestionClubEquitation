...
public class ActiviteDAO extends CommonDAO<Activite> {
    ...
    public static void main(String args[]) {
        ...
        while (it.hasNext()) {
            ...
            System.out.println("NbPlace dispos : " + activiteDAO.getNbPlaceDispo(activite2.getActivite_id()));
        }
        ...
        List<Activite> listTmp = activiteDAO.findAllFuturDateNotCanceled();
        for(Activite a : listTmp) {
