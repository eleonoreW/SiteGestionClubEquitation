...
public class SQLConstant {
    ...
    public static final String SELECT_ALL_RESERVATION_FUTUR_DATE_BY_PERSONNE = "SELECT * FROM Reservation WHERE PersonneID = ? AND Date >= ?";
    ...
    public static final String SUM_PLACE_DISPO = "SELECT SUM(NbPersonne) as Count FROM Reservation WHERE ActiviteID = ? AND EstActive = 1";
